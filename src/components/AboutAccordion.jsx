...
const ITEMS = [
  {
    title: 'Loio Advocacia',
    content:
      'Advogado com carreira conhecida, com atuação pautada na excelência jurídica e no compromisso com a defesa dos direitos e garantias fundamentais de cada cliente.',
  },
  {
